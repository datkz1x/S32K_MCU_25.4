...
/*=====================Edit start=====================*/
#define ARM_GPIO_Pin_0 (0U) //PTC12
#define ARM_GPIO_Pin_1 (1U) //PTC13
#define ARM_GPIO_Pin_2 (2U) //PTD15
#define ARM_GPIO_Pin_3 (3U) //PTD16 
/*======================Edit end======================*/
...
typedef struct _ARM_DRIVER_GPIO {
  ...
  void     (*ToggleOutput)    (ARM_GPIO_Pin_t pin);                                  ///< Pointer to \ref ARM_GPIO_ToggleOutput : Toggle GPIO Output Level.
